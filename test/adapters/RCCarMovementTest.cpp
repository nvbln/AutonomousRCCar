...
TEST(RCCarMovementTests, turnsAndStopsWheels) {
  auto mockWheel1 = MockWheel();
  auto mockWheel2 = MockWheel();

  auto rcCarMovement = RCCarMovement(&mockWheel1, &mockWheel2);
...
TEST(RCCarMovementTests, reportsMovementStatusChanges) {
  auto mockWheel1 = NiceMock<MockWheel>();
  auto mockWheel2 = NiceMock<MockWheel>();
