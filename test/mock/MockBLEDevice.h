...
public:
  ...
  MOCK_METHOD(std::unique_ptr<IBLEService>, createService, (const char *uuid), (const, override));
  MOCK_METHOD(std::unique_ptr<IBLECharacteristic>, createCharacteristic, (const char *uuid),
              (const, override));
  MOCK_METHOD(void, addService, (IBLEService *), (override));
  MOCK_METHOD(void, setAdvertisedService, (IBLEService *), (override));
